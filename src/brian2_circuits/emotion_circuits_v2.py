...
def register_fear_circuit(core: SharedCoreNetwork) -> None:
    ...
    # CeA PV+: fast feedforward inhibition (Royer 2011 Neuron 69:945 Neuron)
    ...
    core.register_connection("ba_exc", "cel_vip", 0.15, 3.0,
                             note="BA→CeL VIP+ input-gated activation; McCullough 2018")

    # CeA PV+ connections (Royer 2011 Neuron 69:945 Neuron)
    core.register_connection("cea_pv", "cem", 0.25, 3.0, inh=True,
                             note="CeA PV+→CeM fast inhibition; Royer 2011 Neuron 69:945")
    core.register_connection("cea_pv", "cel_som", 0.20, 2.0, inh=True,
                             note="CeA PV+→SOM+ recurrent; Royer 2011 Neuron 69:945")
    core.register_connection("la_exc", "cea_pv", 0.15, 2.0,
                             note="LA→CeA PV+ feedforward; Royer 2011 Neuron 69:945")
