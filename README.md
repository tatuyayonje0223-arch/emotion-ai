...
1. **Rate-matching validation は predictive power 不足** — behavioral prediction
   **empirically confirmed as null** (Phase 9 pilot): 821-neuron model は
   keyword baseline より 18.4% 劣る (36.8% vs 55.3% accuracy, n=38 embedded sample)。
   Details: `docs/phase9_results_initial.md`
